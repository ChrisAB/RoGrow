                      ...
                      <form className="form-signin">
                        ...
                        <div className="col-md-6">
                          <div className="m-1">
                              ...
                              <input onChange={handleChanege('firstName')} type="text" id="inputFirstName" className="form-control" placeholder="First Name" value={firstName} required autoFocus/>
                          </div>
                          <div className="m-1">
                              <label className="text-gray-800 large pl-sm-1 pt-1">Password</label>
                              <input onChange={handleChanege('password')} type="password" id="inputPassword" className="form-control" placeholder="Password" value={password} required></input>
                          </div>
                      </div>
                        <div className="col-md-6">
                          <div className="m-1">
                              <label className="text-gray-800 large pl-sm-1 pt-1">Last Name</label>
                              <input onChange={handleChanege('lastName')} type="text" id="inputLastName" className="form-control" placeholder="Last Name" value={lastName} required autoFocus/>
                          </div>
                          <div className="m-1">
                              <label className="text-gray-800 large pl-sm-1 pt-1">Confirm Password</label>
                              <input onChange={handleChanege('confirmPassword')} type="password" id="inputConfirmPassword" className="form-control" placeholder="Password" required></input>
                          </div>
                      </div>
                    </div>
                         <div>
                           <div className="m-1">
                                     ...
                                     <input onChange={handleChanege('email')} type="email" id="inputEmail" className="form-control" placeholder="Email address" value={email} required autoFocus/>
                           </div>
                         </div>
                         <div>
                           <div className="m-1">
                                     <label className="text-gray-800 large pl-sm-1 pt-1">Country</label>
                                     <input onChange={handleChanege('country')} type="text" id="inputCountry" className="form-control" placeholder="Country" value={country} required autoFocus/>
                           </div>
                         </div>
                         <div>
                           <div className="m-1">
                                     <label className="text-gray-800 large pl-sm-1 pt-1">Region</label>
                                     <input onChange={handleChanege('region')} type="text" id="inputRegion" className="form-control" placeholder="Region" value={region} required autoFocus/>
                           </div>
                         </div>
                         <div>
                           <div className="m-1">
                                     <label className="text-gray-800 large pl-sm-1 pt-1">Address</label>
                                     <input onChange={handleChanege('address')} type="text" id="inputAddress" className="form-control" placeholder="Address" value={address} required autoFocus/>
                           </div>
                         </div>
